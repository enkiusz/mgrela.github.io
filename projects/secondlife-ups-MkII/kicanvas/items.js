...
//        this.id = e.expect_pair_number("id");
        this.id = e.maybe_pair_number("id");
        ...
        console.log("effects are", this.effects);
    }
}
...
export class Stroke {
    constructor(e) {
        ...
        const color = e.maybe_expr("color");
        this.color = color ? parse_color(color) : "rgba(128,128,128)";
    }
}
